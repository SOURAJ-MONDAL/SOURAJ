...
if user_type == "patient":
    ...
    if st.session_state.active_chat_session_id is None:
        ...
        companion_slot = st.empty()  # the animated AI companion figurine lives here — always
        # fixed to the bottom-right corner of the screen (see bot_companion.py), so its
        # position here in the layout doesn't matter, only that it's on this patient page.
